 ...
 * `wan2.7-image` — the faithful vendor mirror (D25): DashScope's
 ...
 * read 2026-09-16.
 */
export const zWan27ImageBody = z.object({
    input: z.object({
    ...
    parameters: z.object({
        ...
        enable_sequential: z
            ...
            .optional(),
        size: z
            .union([z.enum(["1K", "2K"]), z.string().regex(/^\d+\*\d+$/)])
            .describe(
                'Output resolution: "1K" or "2K" (the DashScope default) — or an explicit "width*height" (768*768 up to 2048*2048 total pixels, aspect ratio 1:8 to 8:1). Price does not vary by size.',
            )
            .optional(),
        n: z
            .number()
