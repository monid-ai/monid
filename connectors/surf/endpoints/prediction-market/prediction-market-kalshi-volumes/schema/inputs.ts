...
/** GET /prediction-market/kalshi/volumes query params (ported from v1; faithful vendor mirror,
 *  optionality only — vendor defaults are applied at the binding). */
export const zPredictionMarketKalshiVolumesQueryParams = z.object({
