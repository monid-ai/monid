...
/**
 * `POST /motion-control/kling-3.0` body — the faithful vendor mirror (D25).
 * Live docs https://kling.ai/document-api/api/video/3-0-omni/motion-control,
 ...
 */
export const zMotionControlKling30Body = z.object({
    contents: z
        .array(
