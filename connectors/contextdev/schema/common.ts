...
/** Residential proxy exit country / result localization. Context.dev
 *  enumerates ~200 ISO codes per endpoint; the pattern is the honest
 *  subset a doc can carry, and an unsupported code is the vendor's own
 *  free 400. */
export const zCountry = z.string().regex(/^[a-z]{2}$/).describe(
