...
/**
 * Ark create-task body for Seedance 2.0 Fast — the faithful vendor mirror
 * (D25): optionality only, no defaults (those live at the binding).
 *
 * Fast is the quick-iteration tier: same capability surface as 2.0, minus
 * 1080p and 4K. Its two resolutions share one published rate.
 */
export const zSeedance20FastBody = z.object({
