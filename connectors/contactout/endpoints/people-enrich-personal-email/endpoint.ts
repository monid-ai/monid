...
export default defineEndpoint({
    meta: {
        ...
        notes: [
            ...
            "Billed per match: one search credit each, plus one email " +
            "credit per personal email and one phone credit per phone " +
            "number returned. A 404 miss costs nothing.",
        ],
    },
