...
/** The playground `general` agent's input (https://docs.mrscraper.com/docs/api/playground/scrape-json, 2026-09-17); options lifted to
 *  the query by `toRequest`, the agent name pinned there (design D2). */
export const zScrapeExtractBody = z.object({
    url: zAnyPageUrl,
