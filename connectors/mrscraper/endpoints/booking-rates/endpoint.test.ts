...
const ID = "mrscraper#booking/rates";
...
Deno.test(`${ID}: only this site's URL passes the gate; the body is strict`, async () => {
    ...
    for (
        const bad of [
            { "url": "https://www.agoda.com/hotel/th/admiral.html" },
            { "url": "https://booking.attacker.example/hotel/th/admiral.html" },
            {
                "url": "https://www.booking.com/hotel/th/admiral.html",
                "currency": "USD",
            },
        ]
    ) {
    ...
    const twin = await run({
        "url":
            "https://www.booking.co.uk/hotel/th/admiral.html?checkin=2026-10-14&checkout=2026-10-16",
    });
