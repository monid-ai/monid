...
const ID = "mrscraper#tiktok/catalog";
...
Deno.test(`${ID}: only this site's URL passes the gate; the body is strict`, async () => {
    ...
    for (
        const bad of [
            ...
            {
                "url":
                    "https://tiktok.attacker.example/shop/sg/c/cases-screen-protectors/601925",
            },
            {
                "url":
                    "https://www.tiktok.com/shop/sg/c/cases-screen-protectors/601925",
    ...
    const twin = await run({
        "url":
            "https://shop.tiktok.com/shop/sg/c/cases-screen-protectors/601925",
    });
