...
const ID = "mrscraper#agoda/rates";
...
Deno.test(`${ID} happy (synthetic): 46 tokens, the caller gets the inner data`, async () => {
...
Deno.test(`${ID}: only this site's URL passes the gate; the body is strict`, async () => {
    ...
    for (
        const bad of [
            {
                "url":
                    "https://www.booking.com/ad-lib-bangkok/hotel/bangkok-th.html",
            },
            {
                "url":
                    "https://agoda.attacker.example/ad-lib-bangkok/hotel/bangkok-th.html",
            },
            {
                "url":
                    "https://www.agoda.com/ad-lib-bangkok/hotel/bangkok-th.html?checkIn=2026-10-14",
                "proxyCountry": "tha",
            },
        ]
    ) {
    ...
    const twin = await run({
        "url":
            "https://www.agoda.co.th/ad-lib-bangkok/hotel/bangkok-th.html?checkIn=2026-10-14&los=1&adults=2",
        "proxyCountry": "th",
    });
