...
const ID = "mrscraper#walmart/product";
const fixturesDir = fromFileUrl(new URL("./fixtures/", import.meta.url));
const INPUT = {
    body: { "url": "https://www.walmart.com/ip/HP-14-Laptop/17581855155" },
};
...
Deno.test(`${ID}: only this site's URL passes the gate; the body is strict`, async () => {
    ...
    for (
        const bad of [
            ...
            {
                "url":
                    "https://walmart.attacker.example/ip/HP-14-Laptop/17581855155",
            },
            {
    ...
    const twin = await run({
        "url": "https://www.walmart.ca/ip/HP-14-Laptop/17581855155",
        "zipCode": "72712",
        "storeId": "100",
        "country": "ca",
    });
