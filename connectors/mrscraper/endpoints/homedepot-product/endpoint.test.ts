...
const ID = "mrscraper#homedepot/product";
...
Deno.test(`${ID}: only this site's URL passes the gate; the body is strict`, async () => {
    ...
    for (
        const bad of [
            { "url": "https://www.homedepot.com/p/LG-Refrigerator/12345" },
            {
                "url": "https://www.homedepot.com/b/Appliances/N-5yc1v",
                "zipCode": "30301",
            },
            {
                "url": "https://www.lowes.com/p/LG-Refrigerator/12345",
                "zipCode": "30301",
            },
        ]
    ) {
    ...
    const twin = await run({
        "url": "https://www.homedepot.ca/p/LG-Refrigerator/12345",
        "zipCode": "30301",
    });
