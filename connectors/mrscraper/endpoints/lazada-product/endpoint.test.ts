...
const ID = "mrscraper#lazada/product";
...
Deno.test(`${ID}: only this site's URL passes the gate; the body is strict`, async () => {
    ...
    for (
        const bad of [
            { "url": "https://www.shopee.sg/products/pdp-i3158507329.html" },
            {
                "url":
                    "https://lazada.attacker.example/products/pdp-i3158507329.html",
            },
            {
                "url":
                    "https://www.lazada.sg/products/pdp-i3158507329-s22328619522.html",
    ...
    const twin = await run({
        "url":
            "https://www.lazada.co.th/products/pdp-i3158507329-s22328619522.html",
    });
