...
const ID = "mrscraper#tiktok/product";
const fixturesDir = fromFileUrl(new URL("./fixtures/", import.meta.url));
const INPUT = {
    body: { "url": "https://www.tiktok.com/shop/pdp/1731949430853767209" },
};

Deno.test(`${ID} happy (synthetic): 12 tokens, the caller gets the inner data`, async () => {
...
Deno.test(`${ID}: only this site's URL passes the gate; the body is strict`, async () => {
    ...
    for (
        const bad of [
            { "url": "https://www.douyin.com/shop/pdp/1731949430853767209" },
            {
                "url":
                    "https://tiktok.attacker.example/shop/pdp/1731949430853767209",
            },
            {
