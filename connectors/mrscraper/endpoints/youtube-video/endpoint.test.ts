...
const ID = "mrscraper#youtube/video";
const fixturesDir = fromFileUrl(new URL("./fixtures/", import.meta.url));
const INPUT = { body: { url: "https://www.youtube.com/watch?v=HeyIXwZyR8Y" } };
...
Deno.test(`${ID}: the compiled schema gates the input`, async () => {
    ...
    for (
        const bad of [
            { url: "https://www.youtube.com/@MrScraper" },
            { url: "https://youtu.be/HeyIXwZyR8Y" },
            { url: "https://www.youtube.com/watchlist" },
        ]
    ) {
    ...
    const twin = await run({
        url: "https://www.youtube.com/shorts/HeyIXwZyR8Y",
    });
