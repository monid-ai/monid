...
/**
 * Technology Catalog — `GET /v3/domain_analytics/technologies/technologies`
 * (v1 `/domain/technology-catalog`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Technology Catalog",
        summary: "List every detectable website technology, grouped by " +
            "category.",
        description:
            "Free lookup. Returns the technology tree: groups, their " +
            "categories, and the technology names in each, as the " +
            "technology endpoints expect them. To use these values in " +
            ...
            "/domain/technologies-summary, call " +
            "dataforseo#domain/technologies-summary (the endpoint this " +
            "list is for). To use these values in " +
            "/domain/technology-stats, call " +
            "dataforseo#domain/technology-stats (the endpoint this list " +
            "is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/domain_analytics/technologies/technologies/",
        categories: ["company-enrichment"],
    },
    endpoint: "/domain/technology-catalog",
    request: {
        method: "GET",
