...
/**
 * Whois Filter Fields — `GET /v3/domain_analytics/whois/available_filters`
 * (v1 `/domain/whois-filters`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Whois Filter Fields",
        summary: "List the fields the Whois search accepts in filters and " +
            "order_by.",
        description:
            ...
            "/domain/whois, call dataforseo#domain/whois (the endpoint " +
            "this list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/domain_analytics/whois/available_filters/",
        categories: ["seo"],
    },
    endpoint: "/domain/whois-filters",
    request: {
        method: "GET",
