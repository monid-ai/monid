...
export default defineEndpoint({
    meta: {
        ...
        description:
            ...
            "Google's filter facets and sponsored listings. Supports " +
            "depth (up to 120), price range, and sort_by. Suited for " +
            "price comparison and merchant monitoring. To find the " +
