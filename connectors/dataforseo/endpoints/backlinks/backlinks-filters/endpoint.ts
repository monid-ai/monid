...
/**
 * Backlink Filter Fields — `GET /v3/backlinks/available_filters` (v1
 * `/backlinks/filters`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Backlink Filter Fields",
        summary: "List the fields the Backlinks endpoints accept in filters " +
            "and order_by.",
        description:
            ...
            "/backlinks/backlinks, call dataforseo#backlinks/backlinks " +
            "(the endpoint this list is for). To use these values in " +
            "/backlinks/referring-domains, call " +
            "dataforseo#backlinks/referring-domains (the endpoint this " +
            "list is for). To use these values in /backlinks/anchors, " +
            "call dataforseo#backlinks/anchors (the endpoint this list is " +
            "for).",
        docsUrl: "https://docs.dataforseo.com/v3/backlinks/available_filters/",
        categories: ["seo"],
    },
    endpoint: "/backlinks/filters",
    request: { method: "GET", path: "/v3/backlinks/available_filters" },
