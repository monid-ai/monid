...
/**
 * Content Filter Fields — `GET /v3/content_analysis/available_filters` (v1
 * `/content/filters`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Content Filter Fields",
        summary: "List the fields the content analysis endpoints accept in " +
        ...
        description:
            ...
            "/content/search, call dataforseo#content/search (the " +
            "endpoint this list is for). To use these values in " +
            "/content/summary, call dataforseo#content/summary (the " +
            "endpoint this list is for). To use these values in " +
            "/content/sentiment, call dataforseo#content/sentiment (the " +
    ...
    request: { method: "GET", path: "/v3/content_analysis/available_filters" },
