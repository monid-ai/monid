...
/**
 * OnPage Filter Fields — `GET /v3/on_page/available_filters` (v1
 * `/onpage/filters`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "OnPage Filter Fields",
        summary: "List the fields OnPage results can be filtered and sorted " +
            "by.",
        description:
            ...
            "/onpage/instant-pages, call dataforseo#onpage/instant-pages " +
            "(the endpoint this list is for).",
        docsUrl: "https://docs.dataforseo.com/v3/on_page/available_filters/",
        categories: ["seo"],
    },
    endpoint: "/onpage/filters",
    request: { method: "GET", path: "/v3/on_page/available_filters" },
