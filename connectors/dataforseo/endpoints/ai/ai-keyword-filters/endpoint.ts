...
/**
 * AI Keyword Filter Fields — `GET
 * /v3/ai_optimization/ai_keyword_data/available_filters` (v1
 * `/ai/keyword-filters`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "AI Keyword Filter Fields",
        summary:
            "List the fields ai-keyword-search-volume accepts in filters " +
            "and order_by.",
        description:
            ...
            "is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/ai_optimization/ai_keyword_data/available_filters/",
        categories: ["geo"],
    },
    endpoint: "/ai/keyword-filters",
    request: {
        method: "GET",
