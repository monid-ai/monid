...
/**
 * Labs Filter Fields — `GET /v3/dataforseo_labs/available_filters` (v1
 * `/labs/filters`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Labs Filter Fields",
        summary: "List the fields the Labs endpoints accept in filters and " +
            "order_by.",
        description:
            ...
            "/labs/ranked-keywords, call dataforseo#labs/ranked-keywords " +
            "(the endpoint this list is for). To use these values in " +
            "/labs/keywords-for-site, call " +
            "dataforseo#labs/keywords-for-site (the endpoint this list is " +
            "for). To use these values in /labs/related-keywords, call " +
            "dataforseo#labs/related-keywords (the endpoint this list is " +
            "for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/dataforseo_labs/available_filters/",
        categories: ["seo"],
    },
    endpoint: "/labs/filters",
    request: { method: "GET", path: "/v3/dataforseo_labs/available_filters" },
