...
export default defineEndpoint({
    meta: {
        ...
        summary: "Look up App Store app category names for chart requests.",
        description:
            "Free lookup. Returns the App Store category names used by " +
            "app-store-app-list, in one row; search and limit apply to " +
            "the names. To use " +
