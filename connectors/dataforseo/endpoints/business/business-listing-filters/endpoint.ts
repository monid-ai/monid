...
/**
 * Listing Filter Fields — `GET
 * /v3/business_data/business_listings/available_filters` (v1
 * `/business/listing-filters`). Free dictionary lookup (design D7).
 */
export default defineEndpoint({
    meta: {
        displayName: "Listing Filter Fields",
        summary: "List the fields the business listings search accepts in " +
        ...
        description:
            ...
            "list is for).",
        docsUrl:
            "https://docs.dataforseo.com/v3/business_data/business_listings/available_filters/",
        categories: ["maps"],
    },
    endpoint: "/business/listing-filters",
    request: {
        method: "GET",
