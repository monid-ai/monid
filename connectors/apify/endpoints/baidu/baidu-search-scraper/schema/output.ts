...
/**
 * johnvc/Baidu-Search-Scraper — dataset ITEM schema, scaffolded from the actor's
 ...
 */
export const zBaiduSearchScraperOutputItem = z.any();
...
export const zBaiduSearchScraperOutput = z.array(
    zBaiduSearchScraperOutputItem.or(z.record(z.string(), z.unknown())),
);
