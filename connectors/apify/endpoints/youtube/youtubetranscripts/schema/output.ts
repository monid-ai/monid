...
/**
 * johnvc/YoutubeTranscripts — dataset ITEM schema, scaffolded from the actor's
 ...
 */
export const zYoutubetranscriptsOutputItem = z.any();
...
export const zYoutubetranscriptsOutput = z.array(
    zYoutubetranscriptsOutputItem.or(z.record(z.string(), z.unknown())),
);
