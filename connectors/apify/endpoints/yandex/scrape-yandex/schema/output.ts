...
/**
 * johnvc/Scrape-Yandex — dataset ITEM schema, scaffolded from the actor's
 ...
 */
export const zScrapeYandexOutputItem = z.any();
...
export const zScrapeYandexOutput = z.array(
    zScrapeYandexOutputItem.or(z.record(z.string(), z.unknown())),
);
