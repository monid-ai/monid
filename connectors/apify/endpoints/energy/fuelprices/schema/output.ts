...
/**
 * johnvc/fuelprices — dataset ITEM schema, scaffolded from the actor's
 ...
 */
export const zFuelpricesOutputItem = z.any();
...
export const zFuelpricesOutput = z.array(
    zFuelpricesOutputItem.or(z.record(z.string(), z.unknown())),
);
